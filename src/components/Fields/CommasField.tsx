...
export const CommasField = forwardRef(
  (
    {
      value,
      onChange,
    ...
    const handleEnterPress = (e: { target: any; keyCode: number }) => {
    ...
    const handleDeCrement = (input: string) => {
      ...
      setInput(() => checkMinValue(decrement));
    };
    ...
    return (
      <TextField
        ...
        sx={{ ".MuiOutlinedInput-root": { pr: 0.5 }, ...sx }}
        InputProps={{
          ...props.InputProps,
          autoComplete: "off",
          inputProps: {
          ...
          endAdornment: (
            ...
            >
              <ArrowVerticalIcon
                handleClickDown={() => handleDeCrement((input || 0).toString())}
                handleClickUp={() => handleInCrement((input || 0).toString())}
              />
            </InputAdornment>
          ),
        }}
