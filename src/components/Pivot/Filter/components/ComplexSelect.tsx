...
import { AirTableOption } from "../types";
import ColorPicker from "./ColorPicker";
import EditText from "./EditText";
import Tag from "./Tag";
import { toSimplest } from "utils/strings";
import { randomHSLA } from "utils/random";
...
const ListOption = ({
  ...
  const optionsFiltered = useMemo(() => {
    ...
    let list = options.filter((option) => {
      let tempName = toSimplest(option.name);
      let tempSearch = toSimplest(search);
  ...
  return (
    ...
    >
      ...
      <EditText
        ...
        placeholder={onSubmit ? PIVOT_LABEL.add_or_search : PIVOT_LABEL.search}
      />
      {onSubmit && (
        <IconButton
